    ...
    \paragraph{3.2)}
        ...
        \begin{enumerate}
            \item \textit{Comparaison du point de vue du temps de calcul} : \\
                ...
                Dans ces graphiques, nous pouvons observer que pour les deux algorithmes, le temps de calcul augmente de façon linéaire avec $n$ et $p$, et que \texttt{algo\_couplage} est nettement meilleur que \texttt{algo\_glouton} en termes de temps d'exécution. \\
            ...
            \item \textit{Comparaison du point de vue de la qualité de la solution} :  
                ...
                Nous allons donc comparer la dimension (ie la longueurs) des solutions retournées par les deux algorithmes. \\
